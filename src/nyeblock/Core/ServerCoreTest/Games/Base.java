...
public class Base {
	protected HashMap<String,BukkitTask> timers = new HashMap<String,BukkitTask>();
	protected HashMap<String,Integer> timesRan = new HashMap<String,Integer>();
	
	public void createTimer(String name, double delay, int timesToRun, String methodToRun, Object classInstance, Object[] args) {
